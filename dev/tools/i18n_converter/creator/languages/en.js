var en = {
    ...
    "describeList": "Integrator/Web developer,Ad Agency,Kontorol Plugin/Extension/Module Distributor,Social Network,Personal Site,Corporate Site,E-Commerce,E-Learning,Media Company/Producer",
    ...
    "setEntNote": "Entitlement settings will be added to all sub-categories in an asynchronous process. This operation may take a few minutes.\\n\\nNote: This action may impact access to content in the {0} category through existing applications that were not updated to work with the Kontorol entitlement services.\\n\\nAre you sure you want to continue?",
    ...
    "support": "Support",
    "kontorol1000AndUp": "Kontorol 1000 And up",
    ...
    "kontorolDirectoryColumnTitle": "Kontorol Directory",
    ...
    "transcodingSettingsAdvancedModeLiveIntroText": "Here you can define or set a default live transcode profile. Live transcode profiles are available for your \"kontorol streaming\" live broadcasts.",
    ...
    "convertToFlavor": "Use Kontorol Transcoding:",
    ...
    "gen_no_force": "Use Kontorol's Optimization",
    ...
    "metadataMalformedXSDError": "There is an error with your metadata structure. Please contact Kontorol support for assistance",
    ...
    "metadataCustomProfileAlert": "Custom metadata definitions were tailor made for this account by the Kontorol professional services team.<br>If you wish to update the metadata definitions, add or update fields,  please  <a href='http://www.kontorol.com/index.php/kmc/support?type=b326b5062b2f0e69046810717534cb09&pid={0}&email=' target='_blank'><font color='#009acc'>contact Kontorol support</font></a>.",
    ...
    "deleteSchema": "Delete",
    "customSchemaMessage": "* Data Schema was manually set up by Kontorol Professional Services. Please reach out to Account manager for updates / changes.",
    ...
    "forbidden_error": "An unexpected permission error has occurred. Browser page refresh is recommended. When error is persistent, please contact Kontorol Support for additional information.",
    "users_tab": "Users",
    "roles_tab": "Roles",
    ...
    "disabled_options": "<u><a href=\"event:http://site.kontorol.com/Request-Users.html\">Contact us</a></u> to learn more about adding any disabled items below to your account.",
    ...
    "forbiddenError": "An unexpected permission error has occurred. Browser page refresh is recommended. When error is persistent, please contact Kontorol Support for additional information.\\n{0}ad=Andorra",
    ...
    "relatedInfo": "You can attach files (documents, media) to your entries. Uploaded files will not create new entries but will receive a unique Kontorol ID.",
    ...
    "destintaionError": "An error has occurred, please re-check the data you submitted or <a href='http://www.kontorol.com/index.php/kmc/support?type=b326b5062b2f0e69046810717534cb09&pid={0}&email=' target='_blank'><font color='#009acc'>contact Kontorol support</font></a>.",
    "kontorolError": "An error has occurred. Please <a href='http://www.kontorol.com/index.php/kmc/support?type=b326b5062b2f0e69046810717534cb09&pid={0}&email=' target='_blank'><font color='#009acc'>contact Kontorol support</font></a>.",
    ...
    "dfErrAddBulk": "Failed to create bulk upload job in Kontorol.",
    "dfErrBulkUpload": "Failed to execute the bulk upload job in Kontorol.",
    ...
    "dfErrUpdateFile": "Failed to update the drop folder file record in Kontorol.",
    ...
    "dfErrDnldFile": "Failed in file transferring from the drop folder to Kontorol.",
    "dfErrDelFile": "Physical file deletion failed.",
    "megaBytes": "MB",
    "transferringDesc": "File is currently uploading to the drop folder",
    "downloadingDesc": "The file is currently importing from the drop folder to Kontorol",
    ...
    "errDnldDesc": "Failed to import the file from the drop folder to Kontorol",
    "dfUploadStart": "Upload start detected on: {0}",
    "dfUploadEnd": "Upload completion detected on: {0}",
    "dfTranserStart": "File transfer from drop folder to Kontorol started on: {0}",
    "dfTransferEnd": "File transfer of drop folder to Kontorol ended on: {0}",
    ...
    "dfUpsale": "The drop folder capability allows you to easily trigger content ingestion by dropping files into a folder in your environment. To enable this capability for your account, <u><a href='http://corp.kontorol.com/about/contact' target='_blank'>contact us</a></u><br><u><a href='http://knowledge.kontorol.com/kontorol-drop-folders-service-content-ingestion-0' target='_blank'>Learn more about drop folders</a></u>",
    ...
    "kontorolLiveEntryCreatedMessage": "Live Stream Entry has been created successfully. \\nDo you want to view entry details?",
    ...
    "kontorolMulticast": "Multicast (RTP)",
    ...
    "enableDvr": "Enable Live DVR (seeking to early parts of the live stream). DVR window is 30 minutes by default, you can contact Kontorol to adjust this.",
    "enableDvrKontorol": "Enable Live DVR (seeking to early parts of the live stream). DVR window is 2 hours by default.",
    ...
    "forgotPasswordText": "Instructions to reset your password will be sent to your email. if you forgot which email you used, please <a href='http://corp.kontorol.com/about/contact'><u>contact us</u></a>.",
    ...
    "welcome": "Welcome to Kontorol, please select your password.",
    "pleaseLogin": "Your new password has been set, please login to Kontorol management console.",
    ...
    "LOGIN_BLOCKED": "Login denied. You have exceeded the number of invalid login attempts. You can contact Kontorol support at support@kontorol.com to unblock your account.",
    "LOGIN_RETRIES_EXCEEDED": "Your account has been locked, and will not be available for 24 hours. You can contact Kontorol support at support@kontorol.com to unblock your account.",
    ...
    "noEmail": "This email",
    "successMsg": "Thank you for signing up. An email with further instructions has been sent to the email address you provided. If you do not receive an email within a few minutes, please contact support@kontorol.com.",
    "signUp": "Sign Up",
    ...
    "usageDescription": "Please describe how you plan to use Kontorols video platform",
    ...
    "KONTOROL": "Kontorol",
    "KONTOROL_USER_CLIPS": "Kontorol User Clips",
    ...
    "domainExampleLabel": "For example: kontorol.com",
    "domainLabel": "Domain:",
    "saveBtn": "Save",
    "cancelBtn": "Cancel",
    ...
    "tmAdvise1": "Kontorol and TubeMogul have partnered to provide a premium syndication service at the most attractive pricing available.",
    ...
    "tmAdvise4WithLink": "To learn more about this feature and pricing information contact our sales team via the upgrade form <font color='#03c6f7'><b><u><a href='event:http://corp.kontorol.com/about/contact'>http://corp.kontorol.com/about/contact</a></u></b></font> or call +1 800 871 5224.",
    "tmAdvise5": "If you already have a Kontorol-TubeMogul account submit this feed to TubeMogul by following these steps:",
    "tmAdvise6": "Copy the feed URL",
    "tmAdvise7": "Login to your Kontorol-TubeMogul account",
    "tmAdvise8": "In your Kontorol-TubeMogul account go to Advanced Tools> More Tools and select  \"MRSS Feed Manager\"",
    ...
    "importSourceForLink": "<b>Note:</b> When conversion by Kontorol is required, the file defined as Source will be imported to Kontorol.",
